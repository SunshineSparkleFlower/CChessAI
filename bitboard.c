 ...
 * sets board->is_check to 1 if true, 0 if not
 */
...
void bb_generate_all_legal_moves(board_t *board)
{
    ...
    //printf("%d legal knight moves. i == %d\n", board->moves_count, i);
